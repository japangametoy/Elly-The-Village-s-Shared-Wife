...
(function () {
    ...
    Scene_Boot.prototype.start = function () {
        ...
        if (!StorageManager.exists('config')) {
            ConfigManager.alwaysDash = paramAlwaysDash;
            ConfigManager.commandRemember = paramCommandRemember;
            ConfigManager.bgmVolume = paramBgmVolume;
            ConfigManager.bgsVolume = paramBgsVolume;
            ConfigManager.meVolume = paramMeVolume;
            ConfigManager.seVolume = paramSeVolume;
            ConfigManager.save();
        }
    };
})();