...
(() => {
    ...
    Game_Character.prototype.movePosPlayer = function (x, y) {
        if (!this.pos(x, y)) {
            if (this._mppExOriginalSpeed === undefined) {
                this._mppExOriginalSpeed = this.moveSpeed();
                this._mppExOriginalThrough = this.isThrough();
                this.setMoveSpeed(6);
        ...
        if (direction > 0) {
            ...
            if (this._mppExOriginalSpeed !== undefined) {
                this.setMoveSpeed(this._mppExOriginalSpeed);
                this.setThrough(this._mppExOriginalThrough);
                this._mppExOriginalSpeed = undefined;
                this._mppExOriginalThrough = undefined;
            }
